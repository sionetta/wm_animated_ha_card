...
class WashingMachineCard extends HTMLElement {
  ...
  static STRINGS = {
    ...
    pt: {
      ...
      badge_running: "EM ANDAMENTO", badge_idle: "OCIOSA", badge_nodata: "SEM DADOS",
      state_running: "Lavando", state_idle: "Ociosa", state_nodata: "Sem dados",
      ring_running: "DECORRIDO", ring_idle: "OCIOSA",
      power: "Potência atual", current: "Consumo atual",
  ...
  static DEFAULTS = {
    ...
    running_states: [
      ...
      "lavando", "lavagem", "Lavagem Longa", "Lavagem Normal", "Lavagem Curta", "em andamento",
	    "rodando", "ligado", "centrifugação", "centrifugando", "Centrifugacao",
      "Enxague", "enxágue", "enxaguando", "enxaguar", "secando", "secagem", "secar",
